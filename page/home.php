...
session_start();
$admin = $_SESSION["auth"];
$_SESSION["auth"] = $admin; // Mengatur sesi 'auth' dengan nilai tertentu
...
<head>
    ...
    <link rel="shortcut icon" href="image/logopus.png">
...
<body>
    <header>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown" style="margin: 0px 1.5em;">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="margin: 0px 1.5em;">
        ...
        <div class="atas" style="margin-top: 5em;">
