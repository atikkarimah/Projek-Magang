...
<body>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='53'");
                    $i = "false";
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Upaya Kesehatan Kerja</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <?php
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='54'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
            ...
            <h4 style="text-align: left;">UKK Ngupoyo Waluyo</h4>
            <?php
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='55'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
                <img class='card-img-top' src='../image/$tampil[image]' width = '400px' height='450px' alt=''>
                <div class='card' style='text-align: center;>   
                    <h5 class='card-title'>$tampil[title]</h5>
                    <p style='text-align: justify;'>$tampil[content]</p>
                </div> ";
