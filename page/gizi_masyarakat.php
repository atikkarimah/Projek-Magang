...
<body>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='47'");
                    $i = "false";
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Gizi Masyarakat</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <?php
            if ("true" === $admin)
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='48'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
                echo "
    ...
    <div class="row">
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM foto WHERE type='Gizi'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
