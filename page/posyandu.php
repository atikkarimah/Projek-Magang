...
<body>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='11'");
                    $i = "false";
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Posyandu</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <?php
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='31'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
        ...
        <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='60'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        if ($i === "false") echo "<div class='carousel-item active'>";
                        else echo "<div class='carousel-item'>";
                        $i = "true";
                        echo "
                        <img class='d-block w-100' src='../image/$tampil[image]' width='200' height='450' alt='$tampil[content]'>
                    </div>
                    ";
                    }
                    ?> 
    ...
    <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='61'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        if ($i === "false") echo "<div class='carousel-item active'>";
                        else echo "<div class='carousel-item'>";
                        $i = "true";
                        echo "
                        <img class='d-block w-100' src='../image/$tampil[image]' width='100' height='650' alt='$tampil[content]'>
                    </div>
                    ";
                    }
                    ?> 
    ...
    <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='62'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        if ($i === "false") echo "<div class='carousel-item active'>";
                        else echo "<div class='carousel-item'>";
    ...
    <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='63'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        if ($i === "false") echo "<div class='carousel-item active'>";
                        else echo "<div class='carousel-item'>";
                        $i = "true";
                        echo "
                        <img class='d-block w-100' src='../image/$tampil[image]' width='100' height='850' alt='$tampil[content]'>
                    </div>
                    ";
                    }
                    ?> 
    ...
    <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='64'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        if ($i === "false") echo "<div class='carousel-item active'>";
                        else echo "<div class='carousel-item'>";
                        $i = "true";
                        echo "
                        <img class='d-block w-100' src='../image/$tampil[image]' width='100' height='1150' alt='$tampil[content]'>
                    </div>
                    ";
                    }
                    ?> 
                ...
                <li>
                 <p><strong>Link Kuis Kader : </strong><a href="https://forms.gle/hskKqwfhDxoh1trFA"><strong>Kuisioner Kader</strong></a></p>
                </li>
