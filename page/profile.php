...
<body>
    <header>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='67'");
                    $i = "false";
    ...
    <main class="container">
        <div class="content row workingspace">
            <div class="col-6">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='profile'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
            ...
            <div class="col-5">
                <h4 style="text-align: center;">Profile Pengelola</h4>
                <h4 style="text-align: center;">PROMKES UPTD Puskesmas Cilacap Utara I</h4>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='profile'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
