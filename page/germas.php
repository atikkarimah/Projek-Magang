...
<body>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='35'");
                    $i = "false";
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Gerakan Masyarakat Hidup Sehat</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <?php
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='36'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
        ...
        <div class="content row workingspace">
            <div class="col-6">
            <h4 style="text-align: center;">Kegiatan Germas</h4>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='74'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
            ...
            <h4 style="text-align: center;">Kegiatan Germas</h4>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='75'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                    <img src='../image/$tampil[image]' alt='workingspace' class='img-fluid'>
                     ";
