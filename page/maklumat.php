...
<body>
        ...
        <div class="atas" style="margin: 0px 1.5em;">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='27'");
                    $i = "false";
    ...
    <main class="container">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Maklumat Pelayanan</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <div class="edit" style="float: right;">
                <?php if ("true" === $admin) {
                    $idedit = 'isimaklumat';
                    echo
                    "<button id='btn2'><a href='edit_maklumat.php?idmaklumat=$idmaklumat'>Edit Maklumat</a></button>";
                }
                ?>
            </div>
        </div>
        <div id="person">
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='15'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "
