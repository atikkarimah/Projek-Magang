...
<body>
    <header>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='headkelurahan'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        ...
                        $i = "true";
                        echo "
                        <img class='d-block w-100' src='../image/$tampil[image]' width='900' height='250' alt='$tampil[content]'>
                    </div>
                    ";
                    }
                    ?>
    ...
    <main class="container">
        <div class="content row workingspace">
            <div class="col-6">
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='Kelurahan'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
            ...
            <div class="col-5">
                <h4 style="text-align: center;">Wilayah Kerja</h4>
                ...
                <?php if ("true" === $admin) {
                    $idedit = 'kelurahan';
                    echo
                    "<button id='btn2'><a href='edit_kelurahan.php?idkelurahan=$idkelurahan'>Edit</a></button>";
                }
                ?>
            </div>
        </div>
