...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="nav-item active">   
                    ...
                    if ($admin === "true") {
                        ...
                        echo " <a class='nav-link btn-primary ' style='border-radius: 50px;' href='login.html'>login Admin<span class='sr-only'>(current)</span></a>";
                    }
                    ?>
                    </form>
                </div>
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='37'");
                    $i = "false";
                    while ($tampil = mysqli_fetch_array($ambildata)) {
                        ...
                        $i = "true";
                        echo "
                        <img class='d-block w-100' src='../image/$tampil[image]' width='950' height='200' alt='$tampil[content]'>
                    </div>
                    ";
                    }
                    ?>
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Lapis Legit</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <?php
            if ("true" === $admin)
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='38'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
                echo "
                <div class='card' style='text-align: center;>   
                    ...
                    <img class='card-img-top' src='../image/$tampil[image]' width = '400px' height='750px' alt=''>
                </div> ";
            ?>
            <?php } ?>
            </div>
                ...
                <?php
                if ("true" === $admin) {
                    $idlapislegit = 'lapislegit';
                    echo
                    "<button id='btn2'><a href='edit_lapislegit.php?idlapislegit=$idlapislegit'>Edit</a></button>";
                }
                ?>
            ...
            <div class="row">
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM foto WHERE type='LapisLegit'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
        ...
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
        <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM video WHERE id='13'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
            ...
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM video WHERE id='12'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "<div class='card' style='margin-top:55px'>
                    <div class='col-12' id='foto'>
                    <table>
            ...
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM video WHERE id='11'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                echo "<div class='card' style='margin-top:55px'>
                    <div class='col-12' id='foto'>
                    <table>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <p>
                            <address>Jl. Perintis Kemerdekaan No.01 Gumilir, Cilacap Utara 53231</address>
                            </p>
                        </li>
                        <li>
