    ...
    <div id="content">
        ...
        ?>
            <form method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <h6>Masukkan Foto Struktur Puskesmas</h6>
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur2'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur3'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur4'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur5'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur6'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur7'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur8'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
...
<?php
        $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='isistruktur9'");
        if ($tampil = mysqli_fetch_array($ambildata)) {
        ?>
            <form method="POST" enctype="multipart/form-data">
                <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
