...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="nav-item active">
                    <?php
                    if ($admin === "true") {
                        echo " <a class='nav-link' btn btn-primary' style='border-radius: 50px;' href='logout.php'>Logout<span class='sr-only'>(current)</span></a>";
                    } else {
        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE id='10'");
                    $i = "false";
    ...
    <div class="container-costum">
        <div class="justify-content-center pl-3 pr-3 pt-5 pb-5">
            <h4 style="text-align: center;">Desa Siaga</h4>
            <h4 style="text-align: center;">UPTD Puskesmas Cilacap Utara I</h4>
            <?php
            if ("true" === $admin)
            include "../config/koneksi.php";
            $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='desa'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
                echo "
        ...
        <div class="row">
            <?php
            $ambildata = mysqli_query($conn, "SELECT * FROM foto WHERE type='DesaSiaga'");
            while ($tampil = mysqli_fetch_array($ambildata)) {
                $idfoto = $tampil["id"];
