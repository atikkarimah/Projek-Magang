        ...
        <div class="atas">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner container">
                    <?php
                    $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE type='headvisimisi'");
                    $i = "false";
    ...
    <main class="container-fluid">
        <div class="content row workingspace">
            ...
            <div class="col-5">
                ...
                <h4 style="text-align: center;">Puskesmas Cilacap Utara I</h4>
                ...
                <h4 style="text-align: center;"><span>Motto</span></h4>
                <?php
                $ambildata = mysqli_query($conn, "SELECT * FROM content WHERE title='motto'");
                while ($tampil = mysqli_fetch_array($ambildata)) {
                    echo "
                        <p style='text-align:justify'>$tampil[content]</p>
                     ";
